                ...
                <div className="fs-6 mb-2">
                    ...
                    <nav style={{"--bs-breadcrumb-divider": "''"}} aria-label="breadcrumb">
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item ps-0" aria-current="page"><MdOutlineNavigateNext className="text-black-50" /><span className="text-black-50">Categoria</span></li>
                            <li className="breadcrumb-item ps-0" aria-current="page"><MdOutlineNavigateNext className="text-black-50" /><span className="fw-bold">{categoria}</span></li>
                        </ol>
                    </nav>
